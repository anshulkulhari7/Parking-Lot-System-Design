...
public class ParkingLot {
    ...
    private final int maxMotorbikeCount=100;
    private final int maxElectricCount=100;

    private class ParkingRate{
        public int hourNumber;
        public double rate;
    }
    private class EntrancePanel{
        public String id;
        public Location address;
    }

    private class ExitPanel{
        public String id;
        public boolean scanTicket(){
            //implement the procedure to scan ticket
            boolean validScan = true;
            return (validScan);
        }
        public boolean processPayment(){
            //implement the function to process the payment
            boolean Paymentcompelete=true;
            if(Paymentcompelete)return true;
            else return false;
        }
